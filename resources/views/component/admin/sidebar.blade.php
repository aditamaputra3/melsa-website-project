...
<aside class="main-sidebar sidebar-dark-melsared1 elevation-4">
    <!-- Brand Logo -->
    ...
    <a href="{{url('/')}}" class="brand-link logo-switch bg-white">
        ...
        <img src="/assets/melsalogo2.png" alt="AdminLTE Docs Logo Large" class="brand-image-xs logo-xl" style="left: 70px;">
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        <!-- Sidebar Menu -->
